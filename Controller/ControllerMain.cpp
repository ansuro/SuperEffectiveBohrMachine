...
class CControllerCtrl : public ITcOCFCtrlImpl<CControllerCtrl, CControllerClassFactory>
{
public:
	CControllerCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("Controller: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CControllerCtrl>;
